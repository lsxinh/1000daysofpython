...
window.bgcolor("blue") 
window.title("Happy Holidays - GIS Scripting Community") 
...
text.write("Happy Holidays !!!", font=("Apple Chancery", 30, "bold"), align="left") 

text.setposition(-230, 150) 
text.color("black") 
# text.setx(50) 
text.write("from", font=("Apple Chancery", 20, "bold"), align="left") 

text.setposition(-150, 130) 
text.color("yellow") 
text.write("codeGIS community", font=("Avenir", 30, "bold"), align="left") 
...
text.color("black") 
text.penup() 
text.setposition(-240,-230) 
text.write("Improve 0.1 % each day with #1000daysofpython", font=("Apple Chancery", 15, "italic"), align="left") 
text.hideturtle() 
